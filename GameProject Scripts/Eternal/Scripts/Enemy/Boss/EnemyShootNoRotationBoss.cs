...
public class EnemyShootNoRotationBoss : MonoBehaviour
{
    [Header("Assignabled")]
    ...
    [Header("Audio")]
    [SerializeField] private GameObject enemyShootSoundNoTarget;
    ...
    private void Shoot()
    {
        if (enemyMove != null)
        {
            ...
            if (timer > shootInterval)
            {
                ...
                if (enemyShootSoundNoTarget != null) Instantiate(enemyShootSoundNoTarget, bulletStartPos.position, Quaternion.identity); // Sound
                timer = 0f;
            }
        }
    }
